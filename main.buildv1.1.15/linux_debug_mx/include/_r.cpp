...
extern void g_APPLICATION_0WEEL_GetTed2Go();
extern void g_m2git_GitClone(bbString l_link,bbBool l_limit,bbString l_destination);
extern void g_m2git_GitPull(bbString l_destination);
...
static struct mx2_main_environment_typeinfo : public bbClassDecls{
  mx2_main_environment_typeinfo():bbClassDecls(bbClassTypeInfo::getNamespace("APPLICATION_WEEL")){
  }
  bbDeclInfo **initDecls(){
    return bbMembers(bbFunctionDecl<void>("GetTed2Go",&g_APPLICATION_0WEEL_GetTed2Go),bbFunctionDecl<void>("UpdateMonkey2",&g_APPLICATION_0WEEL_UpdateMonkey2));
  }
}_mx2_main_environment_typeinfo;
...
struct rt_APPLICATION_0WEEL_ModuleConf : public bbClassTypeInfo{
  ...
  static struct decls_t : public bbClassDecls{
    ...
    bbDeclInfo **initDecls(){
      return bbMembers(bbCtorDecl<t_APPLICATION_0WEEL_ModuleConf>(),bbFieldDecl("Name",&t_APPLICATION_0WEEL_ModuleConf::m_Name),bbFieldDecl("About",&t_APPLICATION_0WEEL_ModuleConf::m_About),bbFieldDecl("Author",&t_APPLICATION_0WEEL_ModuleConf::m_Author),bbFieldDecl("Version",&t_APPLICATION_0WEEL_ModuleConf::m_Version),bbFieldDecl("Depends",&t_APPLICATION_0WEEL_ModuleConf::m_Depends),bbMethodDecl<t_APPLICATION_0WEEL_ModuleConf,bbBool,bbString>("LoadJson",&t_APPLICATION_0WEEL_ModuleConf::m_LoadJson));
    }
  }decls;
...
struct rt_m2ci_M2CI : public bbClassTypeInfo{
  ...
  static struct decls_t : public bbClassDecls{
    decls_t():bbClassDecls(&instance){}
    bbDeclInfo **initDecls(){
      return bbMembers(bbCtorDecl<t_m2ci_M2CI>(),bbFieldDecl("MX2CC",&t_m2ci_M2CI::m_MX2CC),bbMethodDecl<t_m2ci_M2CI,void>("RebuildMX2CC",&t_m2ci_M2CI::m_RebuildMX2CC),bbMethodDecl<t_m2ci_M2CI,void,bbString,bbBool,bbBool,bbBool,bbString,bbString>("BuildProject",&t_m2ci_M2CI::m_BuildProject),bbMethodDecl<t_m2ci_M2CI,void,bbString,bbBool,bbBool,bbString>("BuildModules",&t_m2ci_M2CI::m_BuildModules),bbMethodDecl<t_m2ci_M2CI,void,bbString>("BuildDocs",&t_m2ci_M2CI::m_BuildDocs),bbMethodDecl<t_m2ci_M2CI,void>("BuildDocs",&t_m2ci_M2CI::m_BuildDocs));
    }
  }decls;
...
static struct mx2_main_m2git_2m2git_typeinfo : public bbClassDecls{
  ...
  bbDeclInfo **initDecls(){
    return bbMembers(bbFunctionDecl<void,bbString>("GitPull",&g_m2git_GitPull),bbFunctionDecl<void,bbString,bbBool,bbString>("GitClone",&g_m2git_GitClone));
  }
