...
#ifndef MX2_TEST_OPTIONSET_H
#define MX2_TEST_OPTIONSET_H
...
struct t_std_optionset_Option : public t_std_collections_Stack_1s{
  ...
  t_std_optionset_Option(bbString l_command,bbFunction<void(t_std_optionset_Option*)> l_func,bbInt l_argCount);
  ~t_std_optionset_Option();

  void m_Text(bbString l_value);
  bbString m_Text();
...
struct t_std_optionset_OptionSet : public bbObject{
  ...
  void m_Add(bbString l_cmd,bbFunction<void(t_std_optionset_Option*)> l_func,bbInt l_argc);
